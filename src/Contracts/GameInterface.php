...
interface GameInterface
{
    ...
    /**
     * MUST return the players in this game in initiative order that matches each of $player_names
     * or all players if $player_names omitted.
     * @param string|array|null $player_names MUST be string or array of strings
     * @return PlayerInterface[]|null Return null if no players set
     */
    ...
    /**
     * MUST return all turns or null if no turns have been taken
     * @return array|null
     */
